...
def test_init():
    ...
    test_blog.set(initial_blog_posts)
    app.app.config['TESTING'] = True
    with app.app.test_client() as client:
        yield client, test_blog
        # print('The Test is over!')

def test_create_blog_with_2_posts_1(test_init):
...
def test_create_blog_with_2_posts_adding_1_extra(test_init):
    client, test_blog = test_init
    test_post = {
        "id": 1,
        "author": "Major Tom",
        "title": "Ajax has to buy more players",
        "content": "Can't wait for the players to start.",
    }
...
def test_create_blog_with_empty_elements(test_init):
    client, test_blog = test_init
    test_post = {
        "id": 1,
        "author": "Major Tom",
...
def test_create_blog_with_wrong_elements(test_init):
    client, test_blog = test_init
    test_post = {
        "id": 1,
        "author": 10,
